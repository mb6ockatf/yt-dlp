...
passthrough_module(
    __name__, "...utils", ("WINDOWS_VT_MODE", "windows_enable_vt_mode")
)
...
compat_urlretrieve = compat_urllib_request_urlretrieve = (
    urllib.request.urlretrieve
)
compat_xml_parse_error = compat_xml_etree_ElementTree_ParseError = (
    etree.ParseError
)
