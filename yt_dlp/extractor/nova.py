    ...
    def _real_extract(self, url):
        ...
        def process_format_list(format_list, format_id=""):
            ...
            for format_dict in format_list:
                ...
                if (
                    format_type == "application/x-mpegURL"
                    or format_id == "HLS"
                    or ext == "m3u8"
                ):
                    formats.extend(
                    ...
                    format_type == "application/dash+xml"
                    or format_id == "DASH"
                    or ext == "mpd"
                ):
                    formats.extend(
...
class NovaIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if not config_url:
            ...
            ) or SITES.get(site, DEFAULT_SITE_ID)
