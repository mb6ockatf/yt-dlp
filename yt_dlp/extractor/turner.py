...
class TurnerBaseIE(AdobePassIE):
    ...
    def _extract_cvp_info(
        self, data_src, video_id, path_data={}, ap_data={}, fatal=False
    ):
        ...
        return {
            ...
            "description": strip_or_none(
                xpath_text(video_data, "description")
            ),
            "duration": parse_duration(
                xpath_text(video_data, "length")
                or xpath_text(video_data, "trt")
            ),
