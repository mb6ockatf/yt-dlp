...
class SenateISVPIE(InfoExtractor):
    ...
    _COMMITTEES = {
        ...
        "armed": (
            "76445",
            "https://armed-f.akamaihd.net",
            "2036800",
            "armedservices",
        ),
        "banking": (
            "76446",
            "https://banking-f.akamaihd.net",
            "2036799",
            "banking",
        ),
        "budget": (
            "76447",
            "https://budget-f.akamaihd.net",
            "2036798",
            "budget",
        ),
        ...
        "commerce": (
            "80177",
            "https://commerce1-f.akamaihd.net",
            "2036779",
            "commerce",
        ),
        ...
        "energy": (
            "76448",
            "https://energy-f.akamaihd.net",
            "2036797",
            "energy",
        ),
        "epw": (
            "76478",
            "https://epw-f.akamaihd.net",
            "2036783",
            "environment",
        ),
        "ethics": (
            "76449",
            "https://ethics-f.akamaihd.net",
            "2036796",
            "ethics",
        ),
        "finance": (
            "76450",
            "https://finance-f.akamaihd.net",
            "2036795",
            "finance_finance",
        ),
        "foreign": (
            "76451",
            "https://foreign-f.akamaihd.net",
            "2036794",
            "foreignrelations",
        ),
        "govtaff": (
            "76453",
            "https://govtaff-f.akamaihd.net",
            "2036792",
            "hsgac",
        ),
        ...
        "indian": (
            "76455",
            "https://indian-f.akamaihd.net",
            "2036791",
            "indianaffairs",
        ),
        "intel": (
            "76456",
            "https://intel-f.akamaihd.net",
            "2036790",
            "intelligence",
        ),
        "intlnarc": (
            "76457",
            "https://intlnarc-f.akamaihd.net",
            "",
            "internationalnarcoticscaucus",
        ),
        "jccic": ("85180", "https://jccic-f.akamaihd.net", "2036778", "jccic"),
        "jec": (
            "76458",
            "https://jec-f.akamaihd.net",
            "2036789",
            "jointeconomic",
        ),
        "judiciary": (
            "76459",
            "https://judiciary-f.akamaihd.net",
            "2036788",
            "judiciary",
        ),
    ...
    def _real_extract(self, url):
        ...
        stream_num, stream_domain, stream_id, msl3 = self._COMMITTEES[
            committee
        ]
...
class SenateGovIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        url_info = next(
            SenateISVPIE.extract_from_webpage(self._downloader, url, webpage),
            None,
        )
        if not url_info:
        ...
        title = self._html_search_regex(
            (*self._og_regexes("title"), r"(?s)<title>([^<]*?)</title>"),
            webpage,
            "video title",
            fatal=False,
        )
