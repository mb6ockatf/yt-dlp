...
class SeznamZpravyArticleIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        description = info.get("description") or self._og_search_description(
            webpage
        )
        ...
        return self.playlist_result(
            [
                ...
                for entry_url in SeznamZpravyIE._extract_embed_urls(
                    url, webpage
                )
            ],
            article_id,
