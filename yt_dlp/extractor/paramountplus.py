...
class ParamountPlusIE(CBSBaseIE):
    ...
    def _extract_video_info(self, content_id, mpx_acc=2198311517):
        ...
        try:
            info = self._extract_common_video_info(
                content_id, asset_types, mpx_acc, extra_info=metadata
            )
        ...
        if not info.get("formats"):
            ...
            try:
                drm_info = self._extract_common_video_info(
                    content_id, asset_types, mpx_acc, extra_info=metadata
                )
        ...
        for page in itertools.count():
            ...
            for episode in show_json["result"]["data"]:
                yield self.url_result(
                    ...
                    ie=ParamountPlusIE.ie_key(),
                    video_id=episode["content_id"],
                )
