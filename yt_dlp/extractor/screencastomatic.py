...
class ScreencastOMaticIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if (
            self._html_extract_title(webpage) == "Protected Content"
            ...
            webpage = self._download_webpage(
                "https://screencast-o-matic.com/player/password",
                video_id,
                "Logging in",
            ...
            if (
                ...
                raise ExtractorError(
                    "Unable to login: Invalid password", expected=True
                )
        ...
        info.update(
            {
                ...
                "upload_date": unified_strdate(
                    remove_start(
                        get_element_by_class("overlayPublished", webpage),
                        "Published: ",
                    )
                ),
            }
