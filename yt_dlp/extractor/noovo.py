...
class NoovoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        season_el = (
            try_get(data, lambda x: x["emission"]["saison"], dict) or {}
        )
