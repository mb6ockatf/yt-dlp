...
class YappyIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        media_data = traverse_obj(
            nextjs_data,
            ("props", "pageProps", ("data", "OpenGraphParameters")),
            get_all=False,
        ) or self._download_json(
            f"https://yappy.media/api/video/{video_id}", video_id
        )
        ...
        return {
            ...
            "thumbnail": (
                ...
                or self._html_search_meta(
                    ["og:image", "og:image:secure_url"], webpage
                )
            ),
            "description": (
            ...
            "timestamp": unified_timestamp(
                media_data.get("publishedAt") or json_ld.get("timestamp")
            ),
            "view_count": int_or_none(
                media_data.get("viewsCount") or json_ld.get("view_count")
            ),
            ...
            "uploader_id": traverse_obj(
                media_data, ("creator", ("uuid", "nickname")), get_all=False
            ),
            "categories": traverse_obj(media_data, ("categories", ..., "name"))
            or None,
    ...
    def _real_extract(self, url):
        ...
        def fetch_page(page_num):
            ...
            videos = self._download_json(
                ...
                profile_id,
                f"Downloading profile page {page_num} JSON",
            )
        ...
        return self.playlist_result(
            OnDemandPagedList(fetch_page, 15), profile_id
        )
