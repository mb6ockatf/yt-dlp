...
class BoxCastVideoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        broadcast_json_data = traverse_obj(
            webpage_json_data, ("broadcast", "data")
        ...
        return {
            ...
            "title": (
                broadcast_json_data.get("name")
                or self._html_search_meta(
                    ["og:title", "twitter:title"], webpage
                )
            ),
            "description": (
                broadcast_json_data.get("description")
                or self._html_search_meta(
            ...
            "thumbnail": (
                broadcast_json_data.get("preview")
                or self._html_search_meta(
            ...
            "release_timestamp": unified_timestamp(
                broadcast_json_data.get("streamed_at")
            ),
