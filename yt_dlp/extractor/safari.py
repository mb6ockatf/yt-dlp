...
class SafariBaseIE(InfoExtractor):
    ...
    def _perform_login(self, username, password):
        ...
        auth, urlh = self._download_json_handle(
            "https://www.oreilly.com/member/auth/login/",
            None,
            "Logging in",
            data=json.dumps(
                {
...
class SafariIE(SafariBaseIE):
    ...
    def _real_extract(self, url):
        ...
        if reference_id:
            ...
            video_id = "{}-{}".format(
                mobj.group("course_id"), mobj.group("part")
            )
        ...
        if self.LOGGED_IN:
            kaltura_session = self._download_json(
                ...
                video_id,
                "Downloading kaltura session JSON",
                "Unable to download kaltura session JSON",
                fatal=False,
...
class SafariApiIE(SafariBaseIE):
    ...
    def _real_extract(self, url):
        ...
        part = self._download_json(
            url,
            "{}/{}".format(mobj.group("course_id"), mobj.group("part")),
...
class SafariCourseIE(SafariBaseIE):
    ...
    def suitable(cls, url):
        return (
            False
            if SafariIE.suitable(url) or SafariApiIE.suitable(url)
