...
class Screen9IE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        webpage = self._download_webpage(
            f"https://api.screen9.com/embed/{video_id}", video_id
        )
        ...
        formats, subtitles = self._extract_m3u8_formats_and_subtitles(
            traverse_obj(
                ...
                (
                    "src",
                    lambda _, v: v["type"] == "application/x-mpegURL",
                    "src",
                ),
                get_all=False,
            ),
        ...
        formats.append(
            {
                "url": traverse_obj(
                    config,
                    ("src", lambda _, v: v["type"] == "video/mp4", "src"),
                    get_all=False,
                ),
                "format": "mp4",
            }
        ...
        return {
            ...
            "description": traverse_obj(
                config, ("plugins", "title", "description")
            ),
