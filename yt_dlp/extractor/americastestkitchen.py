...
class AmericasTestKitchenIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "url": "https://player.zype.com/embed/{}.js?api_key=jZ9GUhRmxcPvX7M3SlfejB6Hle9jyHTdk2jVxG7wOHPLODgncEKVdPYBhuz9iWXQ".format(
                video["zypeId"]
            ),
            "ie_key": "Zype",
...
class AmericasTestKitchenSeasonIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        season_number, show1, show = self._match_valid_url(url).group(
            "season", "show", "show2"
        )
        ...
        def entries():
            for episode in season_search.get("hits") or []:
                ...
                yield {
                    ...
                    "id": try_get(
                        episode, lambda e: e["objectID"].split("_")[-1]
                    ),
