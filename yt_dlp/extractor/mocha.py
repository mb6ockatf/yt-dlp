...
class MochaVideoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        video_urls = (json_data.get("list_resolution") or []) + [
            json_data.get("original_path")
        ]
        ...
        return {
            ...
            "timestamp": int_or_none(
                json_data.get("publish_time"), scale=1000
            ),
            ...
            "channel_follower_count": traverse_obj(
                json_data, ("channels", "0", "numfollow")
            ),
            "categories": traverse_obj(
                json_data, ("categories", ..., "categoryname")
            ),
