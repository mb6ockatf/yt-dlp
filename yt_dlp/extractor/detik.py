        ...
        },
        {
            ...
            "info_dict": {
                ...
                "tags": [
                    ...
                    " zodiak",
                    " ramalan bintang",
                    " zodiak beruntung 2022",
                    " zodiak hoki september 2022",
                    " zodiak beruntung september 2022",
                ],
        ...
        },
        {
            ...
            "info_dict": {
                ...
                "tags": [
                    "hacker bjorka",
                    "bjorka",
                    "hacker bjorka bocorkan data rahasia presiden jokowi",
                    "jokowi",
                ],
            },
        },
        ...
        if player_type == "flowplayer":
            ...
            extra_info_dict = {
                "id": self._search_regex(
                    r"identifier\s*:\s*\'([^\']+)", webpage, "identifier"
                ),
            ...
            extra_info_dict = {
                ...
                "duration": int_or_none(
                    self._html_search_meta(
                        "duration", webpage, fatal=False, default=None
                    )
                ),
        ...
        yield merge_dicts(
            ...
            extra_info_dict,
            {
                ...
                "title": self._html_search_meta(
                    ["og:title", "originalTitle"], webpage
                )
                ...
                "tags": try_call(
                    lambda: self._html_search_meta(
                        ["keywords", "keyword", "dtk:keywords"], webpage
                    ).split(",")
                ),
            },
        )
