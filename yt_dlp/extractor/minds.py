...
class MindsIE(MindsBaseIE):
    ...
    def _real_extract(self, url):
        ...
        entity = self._call_api(
            "v1/entities/entity/" + entity_id, entity_id, "entity"
        )["entity"]
        ...
        return {
            ...
            "uploader_url": format_field(
                uploader_id, None, "https://www.minds.com/%s"
            ),
...
class MindsFeedBaseIE(MindsBaseIE):
    ...
    def _entries(self, feed_id):
        ...
        while True:
            ...
            if not (
                query["from_timestamp"] and len(entities) == self._PAGE_SIZE
            ):
                break
            i += 1
    ...
    def _real_extract(self, url):
        ...
        feed = self._call_api(
            f"v1/{self._FEED_PATH}/{feed_id}", feed_id, self._FEED_TYPE
        )[self._FEED_TYPE]

        return self.playlist_result(
            self._entries(feed["guid"]),
            feed_id,
