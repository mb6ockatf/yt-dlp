...
class BerufeTVIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        meta = traverse_obj(
            movie_metadata,
            ("metadaten", lambda _, i: video_id == i["miId"]),
            get_all=False,
            default={},
        )
        ...
        return {
            ...
            or traverse_obj(video, ("videoMetaData", "title")),
            "description": meta.get("beschreibung"),
            "thumbnail": meta.get("thumbnail")
            or f"https://asset-out-cdn.video-cdn.net/private/videos/{video_id}/thumbnails/active",
            "duration": float_or_none(video.get("duration"), scale=1000),
            "categories": (
                [meta["kategorie"]] if meta.get("kategorie") else None
            ),
