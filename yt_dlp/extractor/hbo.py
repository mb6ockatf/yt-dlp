    ...
    def _extract_info(self, url, display_id):
                    ...
                    fmt.update(
                        {
                            ...
                            "app": rtmp.group("app"),
                            "ext": "flv",
                            "format_id": fmt["format_id"].replace(
                                "http", "rtmp"
                            ),
                        }
                    )
        ...
        return {
            ...
            "duration": parse_duration(
                xpath_text(video_data, "duration/tv14")
            ),
            "series": series,
...
class HBOIE(HBOBaseIE):
    ...
    _TEST = {
        ...
        "expected_warnings": [
            "Unknown MIME type application/mp4 in DASH manifest"
        ],
    }
    ...
    def _real_extract(self, url):
        ...
        location_path = self._parse_json(
            self._html_search_regex(r'data-state="({.+?})"', webpage, "state"),
            display_id,
        )["video"]["locationUrl"]
