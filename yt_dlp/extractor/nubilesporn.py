    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "channel_url": format_field(
                channel_id,
                None,
                "https://members.nubiles-porn.com/video/website/%s",
            ),
            "like_count": int_or_none(get_element_by_id("likecount", page)),
            "average_rating": float_or_none(
                get_element_by_class("score", page)
            ),
            "age_limit": 18,
            "categories": traverse_obj(
                page,
                (
                    {find_element(cls="categories")},
                    {find_elements(cls="btn")},
                    ...,
                    {clean_html},
                ),
            ),
