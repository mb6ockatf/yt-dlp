    ...
    def _real_extract(self, url):
        ...
        if "video" not in all_info and "audio" not in all_info:
            ...
            if not entries:
                ...
                if videos:
                    entries = [
                        self.url_result(f"srgssr:{video_urn}", "SRGSSR")
                        for video_urn in videos
                    ]
        ...
        info = (
            all_info["video"]["JSONinfo"]
            if "video" in all_info
            else all_info["audio"]
        )
        ...
        download_base = "http://rtsww{}-d.rts.ch/".format(
