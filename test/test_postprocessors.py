...
class TestMetadataFromField(unittest.TestCase):
    ...
    def test_format_to_regex(self):
        ...
        self.assertEqual(
            MetadataParserPP.format_to_regex(r"(?P<x>.+)"), r"(?P<x>.+)"
        )

    def test_field_to_template(self):
        self.assertEqual(
            MetadataParserPP.field_to_template("title"), "%(title)s"
        )
        self.assertEqual(MetadataParserPP.field_to_template("1"), "1")
        self.assertEqual(
            MetadataParserPP.field_to_template("foo bar"), "foo bar"
        )
        self.assertEqual(
            MetadataParserPP.field_to_template(" literal"), " literal"
        )

    def test_metadatafromfield(self):
        self.assertEqual(
            MetadataFromFieldPP.to_action(
...
class TestModifyChaptersPP(unittest.TestCase):
    ...
    def test_remove_marked_arrange_sponsors_UniqueNamesForOverlappingSponsors(
        self,
    ):
        chapters = [
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithCuts(self):
        cuts = [
            self._chapter(10, 20, remove=True),
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithSponsorCutInTheMiddle(
        self,
    ):
        cuts = [
            self._sponsor_chapter(20, 30, "selfpromo", remove=True),
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithOverlappingSponsors(
        self,
    ):
        chapters = [
            *self._chapters([70], ["c"]),
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithOverlappingCuts(self):
        ...
        self._remove_marked_arrange_sponsors_test_impl(
            chapters,
            self._chapters([20], ["c"]),
            [self._chapter(10, 60, remove=True)],
        )

    def test_remove_marked_arrange_sponsors_ChapterWithRunsOfOverlappingSponsors(
        self,
    ):
        chapters = [
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithRunsOfOverlappingCuts(
        self,
    ):
        chapters = [
            *self._chapters([170], ["c"]),
        ...
        expected_cuts = [
            self._chapter(0, 60, remove=True),
    ...
    def test_remove_marked_arrange_sponsors_OverlappingSponsorsDifferentTitlesAfterCut(
        self,
    ):
        chapters = [
            *self._chapters([60], ["c"]),
    ...
    def test_remove_marked_arrange_sponsors_SponsorsNoLongerOverlapAfterCut(
        self,
    ):
        chapters = [
            *self._chapters([70], ["c"]),
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithRunsOfOverlappingSponsorsAndCuts(
        self,
    ):
        chapters = [
        ...
        self._remove_marked_arrange_sponsors_test_impl(
            chapters, expected, expected_cuts
        )

    def test_remove_marked_arrange_sponsors_SponsorOverlapsMultipleChapters(
        self,
    ):
        chapters = [
            *self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_SponsorsWithinSomeChaptersAndOverlappingOthers(
        self,
    ):
        chapters = [
    ...
    def test_remove_marked_arrange_sponsors_CutsWithinSomeChaptersAndOverlappingOthers(
        self,
    ):
        cuts = [
            self._chapter(20, 30, remove=True),
            self._chapter(50, 70, remove=True),
        ]
        chapters = (
            self._chapters([10, 40, 60, 80], ["c1", "c2", "c3", "c4"]) + cuts
        )
    ...
    def test_remove_marked_arrange_sponsors_ChaptersAfterLastCut(self):
        ...
        chapters = (
            self._chapters([20, 40, 50, 60], ["c1", "c2", "c3", "c4"]) + cuts
        )
    ...
    def test_remove_marked_arrange_sponsors_CutCoincidesWithChapters(self):
        cuts = [self._chapter(10, 30, remove=True)]
        chapters = (
            self._chapters([10, 20, 30, 40], ["c1", "c2", "c3", "c4"]) + cuts
        )
    ...
    def test_remove_marked_arrange_sponsors_CutsAtVideoBoundaries(self):
        cuts = [
            self._chapter(0, 10, remove=True),
            self._chapter(50, 60, remove=True),
        ]
    ...
    def test_remove_marked_arrange_sponsors_SponsorsOverlapChaptersAtVideoBoundaries(
        self,
    ):
        chapters = [
    ...
    def test_remove_marked_arrange_sponsors_CutsOverlapChaptersAtVideoBoundaries(
        self,
    ):
        cuts = [
            self._chapter(0, 20, remove=True),
            self._chapter(30, 50, remove=True),
        ]
    ...
    def test_remove_marked_arrange_sponsors_EverythingCut(self):
        cuts = [
            self._chapter(0, 20, remove=True),
            self._chapter(20, 40, remove=True),
        ]
        chapters = (
            self._chapters([10, 20, 30, 40], ["c1", "c2", "c3", "c4"]) + cuts
        )
    ...
    def test_remove_marked_arrange_sponsors_TinyChaptersInTheOriginalArePreserved(
        self,
    ):
    ...
    def test_remove_marked_arrange_sponsors_TinySponsorsAreIgnored(self):
        chapters = [
            self._sponsor_chapter(0, 0.1, "intro"),
            self._chapter(0.1, 0.2, "c1"),
            self._sponsor_chapter(0.2, 0.3, "sponsor"),
            self._chapter(0.3, 0.4, "c2"),
    ...
    def test_remove_marked_arrange_sponsors_TinyChaptersResultingFromCutsAreIgnored(
        self,
    ):
    ...
    def test_remove_marked_arrange_sponsors_TinyChapterAtTheStartPrependedToTheNext(
        self,
    ):
        cuts = [self._chapter(0.5, 2, remove=True)]
    ...
    def test_remove_marked_arrange_sponsors_TinyChaptersResultingFromSponsorOverlapAreIgnored(
        self,
    ):
        chapters = [
    ...
    def test_remove_marked_arrange_sponsors_TinySponsorsOverlapsAreIgnored(
        self,
    ):
        chapters = [
    ...
    def test_remove_marked_arrange_sponsors_TinySponsorsPrependedToTheNextSponsor(
        self,
    ):
        chapters = [
            *self._chapters([4], ["c"]),
    ...
    def test_remove_marked_arrange_sponsors_SmallestSponsorInTheOverlapGetsNamed(
        self,
    ):
    ...
    def test_make_concat_opts_CommonCase(self):
        sponsor_chapters = [
            self._chapter(1, 2, "s1"),
            self._chapter(10, 20, "s2"),
        ]
...
"""
        ...
        self.assertEqual(
            expected,
            "".join(self._pp._concat_spec(["test"] * len(opts), opts)),
        )

    def test_make_concat_opts_NoZeroDurationChunkAtVideoStart(self):
        sponsor_chapters = [
            self._chapter(0, 1, "s1"),
            self._chapter(10, 20, "s2"),
        ]
        expected = """ffconcat version 1.0
file 'file:test'
