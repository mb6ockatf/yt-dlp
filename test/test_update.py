...
class TestUpdate(unittest.TestCase):
    ...
    def test_update_spec(self):
        ...
        for lockfile in (
            ...
            test(
                lockfile, "zip Python 3.8.110", "2025.01.01", None, exact=True
            )
            test(  # Windows Vista w/ win_x86_exe must be locked at Vista lock
                lockfile,
                "win_x86_exe Python 3.7.9 (CPython x86 32bit) - Windows-Vista-6.0.6003-SP2",
                "2023.12.31",
                "2023.11.16",
            )
            ...
            test(  # Windows 7 w/ win_x86_exe py3.7 build should be able to update beyond py3.7 lock
                lockfile,
                "win_x86_exe Python 3.7.9 (CPython x86 32bit) - Windows-7-6.1.7601-SP1",
                "2023.12.31",
                "2023.12.31",
                exact=True,
            )
            ...
            test(  # Windows 2008ServerR2 win_exe should only update to Win7 lock
                lockfile,
                "win_exe Python 3.8.10 (CPython x86 32bit) - Windows-2008ServerR2",
                "2025.12.31",
                "2024.10.22",
            )
            ...
            test(  # win_exe built w/Python 3.8 on Windows>=8 should be able to update beyond py3.8 lock
                lockfile,
                "win_exe Python 3.8.10 (CPython AMD64 64bit) - Windows-10-10.0.20348-SP0",
                "2025.01.01",
                "2025.01.01",
                exact=True,
            )
            test(  # linux_armv7l_exe w/glibc2.7 should only update to glibc<2.31 lock
                lockfile,
                "linux_armv7l_exe Python 3.8.0 (CPython armv7l 32bit) - Linux-6.5.0-1025-azure-armv7l-with-glibc2.7",
                "2025.01.01",
                "2024.10.22",
            )
            test(  # linux_armv7l_exe w/Python 3.8 and glibc>=2.31 should be able to update beyond py3.8 and glibc<2.31 locks
                lockfile,
                "linux_armv7l_exe Python 3.8.0 (CPython armv7l 32bit) - Linux-6.5.0-1025-azure-armv7l-with-glibc2.31",
                "2025.01.01",
                "2025.01.01",
            )
            test(  # linux_armv7l_exe w/glibc2.30 should only update to glibc<2.31 lock
                lockfile,
                "linux_armv7l_exe Python 3.8.0 (CPython armv7l 64bit) - Linux-6.5.0-1025-azure-aarch64-with-glibc2.30 (OpenSSL",
                "2025.01.01",
                "2024.10.22",
            )
            test(  # linux_aarch64_exe w/glibc2.17 should only update to glibc<2.31 lock
                lockfile,
                "linux_aarch64_exe Python 3.8.0 (CPython aarch64 64bit) - Linux-6.5.0-1025-azure-aarch64-with-glibc2.17",
                "2025.01.01",
                "2024.10.22",
            )
            test(  # linux_aarch64_exe w/glibc2.40 and glibc>=2.31 should be able to update beyond py3.8 and glibc<2.31 locks
                lockfile,
                "linux_aarch64_exe Python 3.8.0 (CPython aarch64 64bit) - Linux-6.5.0-1025-azure-aarch64-with-glibc2.40",
                "2025.01.01",
                "2025.01.01",
            )
            test(  # linux_aarch64_exe w/glibc2.3 should only update to glibc<2.31 lock
                lockfile,
                "linux_aarch64_exe Python 3.8.0 (CPython aarch64 64bit) - Linux-6.5.0-1025-azure-aarch64-with-glibc2.3 (OpenSSL",
                "2025.01.01",
                "2024.10.22",
            )
    ...
    def test_query_update(self):
        ...
        def test(
            ...
            self.assertDictEqual(
                update_info.__dict__ if update_info else {},
                expected.__dict__ if expected else {},
            )
        ...
        test(
            ...
            UpdateInfo(
                "2023.12.31.123456",
                version="2023.12.31.123456",
                requested_version="2023.12.31.123456",
                commit="c" * 40,
            ),
        )
        test(
            ...
            UpdateInfo(
                "2023.12.31.987654",
                version="2023.12.31.987654",
                requested_version="2023.12.31.987654",
                commit="d" * 40,
            ),
        )
        test(
        ...
        test(
            ...
            UpdateInfo(
                "pr0000",
                version="2023.11.11.000000",
                requested_version="2023.11.11.000000",
                commit="f" * 40,
            ),
        )
        test(
            ...
            UpdateInfo(
                "pr1234",
                version="2023.12.31.555555",
                requested_version="2023.12.31.555555",
                commit="0" * 40,
            ),
        )
        test(
