...
class TestAllURLsMatching(unittest.TestCase):
    ...
    def test_youtube_playlist_matching(self):
        assertPlaylist = lambda url: self.assertMatch(
        ...
        self.assertFalse(
            "youtube:playlist" in self.matching_ies("PLtS2H6bU1M")
        )
        # Top tracks
    ...
    def test_youtube_matching(self):
        ...
        self.assertMatch(
            "https://youtube.googleapis.com/v/BaW_jenozKc", ["youtube"]
        )
        self.assertMatch(
    ...
    def test_youtube_user_matching(self):
        self.assertMatch(
            "http://www.youtube.com/NASAgovVideo/videos", ["youtube:tab"]
        )

    def test_youtube_feeds(self):
        self.assertMatch(
            "https://www.youtube.com/feed/library", ["youtube:tab"]
        )
        self.assertMatch(
            "https://www.youtube.com/feed/history", ["youtube:tab"]
        )
        self.assertMatch(
            "https://www.youtube.com/feed/watch_later", ["youtube:tab"]
        )
        self.assertMatch(
            "https://www.youtube.com/feed/subscriptions", ["youtube:tab"]
        )
    ...
    def test_vimeo_matching(self):
        self.assertMatch(
            "https://vimeo.com/channels/tributes", ["vimeo:channel"]
        )
        self.assertMatch("https://vimeo.com/channels/31259", ["vimeo:channel"])
        self.assertMatch(
            "https://vimeo.com/channels/31259/53576664", ["vimeo"]
        )
        self.assertMatch("https://vimeo.com/user7108434", ["vimeo:user"])
        self.assertMatch(
            "https://vimeo.com/user7108434/videos", ["vimeo:user"]
        )
        self.assertMatch(
    ...
    def test_soundcloud_not_matching_sets(self):
        self.assertMatch(
            "http://soundcloud.com/floex/sets/gone-ep", ["soundcloud:set"]
        )
    ...
    def test_pbs(self):
        ...
        self.assertMatch(
            "http://video.pbs.org/viralplayer/2365173446/", ["pbs"]
        )
        self.assertMatch(
