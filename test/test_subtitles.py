...
class TestYoutubeSubtitles(BaseTestSubtitles):
    ...
    def test_youtube_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["en"]), "ae1bd34126571a77aabd4d276b28044d"
        )
        self.assertEqual(
        ...
        for lang in ["fr", "de"]:
            self.assertTrue(
                ...
                f"Subtitles for '{lang}' not extracted",
            )
    ...
    def test_youtube_subtitles_json3_format(self):
        self._test_subtitles_format(
            "json3", "688dd1ce0981683867e7fe6fde2a224b"
        )
...
class TestDailymotionSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["en"]), "976553874490cba125086bbfea3ff76f"
        )
        self.assertEqual(
...
class TestTedSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["en"]), "4262c1665ff928a2dada178f62cb8d14"
        )
        self.assertEqual(
...
class TestVimeoSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["en"]), "386cbc9320b94e25cb364b97935e5dd1"
        )
        self.assertEqual(
...
class TestWallaSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["heb"]), "e758c5d7cb982f6bef14f377ec7a3920"
        )
...
class TestLyndaSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["en"]), "09bbe67222259bed60deaa26997d73a7"
        )
...
class TestNPOSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["nl"]), "fc6435027572b63fb4ab143abd5ad3f4"
        )
...
class TestNRKSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(
            md5(subtitles["nb-ttv"]), "67e06ff02d0deaf975e68f6cb8f6a149"
        )
...
class TestRaiPlaySubtitles(BaseTestSubtitles):
    ...
    def test_subtitles_key(self):
        ...
        self.assertEqual(
            md5(subtitles["it"]), "b1d90a98755126b61e667567a1f6680a"
        )
    ...
    def test_subtitles_array_key(self):
        ...
        self.assertEqual(set(subtitles.keys()), {"it"})
        self.assertEqual(
            md5(subtitles["it"]), "4b3264186fbb103508abe5311cfcb9cd"
        )
...
class TestVikiSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(set(subtitles.keys()), {"en"})
        self.assertEqual(
            md5(subtitles["en"]), "53cb083a5914b2d84ef1ab67b880d18a"
        )
...
class TestThePlatformSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(set(subtitles.keys()), {"en"})
        self.assertEqual(
            md5(subtitles["en"]), "97e7670cbae3c4d26ae8bcc7fdd78d4b"
        )
...
class TestThePlatformFeedSubtitles(BaseTestSubtitles):
    ...
    def test_allsubtitles(self):
        ...
        self.assertEqual(set(subtitles.keys()), {"en"})
        self.assertEqual(
            md5(subtitles["en"]), "48649a22e82b2da21c9a67a395eedade"
        )
...
class TestPBSSubtitles(BaseTestSubtitles):
    ...
    def test_subtitles_dfxp_format(self):
        ...
        subtitles = self.getSubtitles()
        self.assertIn(
            md5(subtitles["en"]), ["643b034254cdc3768ff1e750b6b5873b"]
        )
    ...
    def test_subtitles_srt_format(self):
        ...
        subtitles = self.getSubtitles()
        self.assertIn(
            md5(subtitles["en"]), ["2082c21b43759d9bf172931b2f2ca371"]
        )
    ...
    def test_subtitles_sami_format(self):
        ...
        subtitles = self.getSubtitles()
        self.assertIn(
            md5(subtitles["en"]), ["4256b16ac7da6a6780fafd04294e85cd"]
        )
