        ...
        try:
            ...
            while True:
                try:
                    ...
                    if not isinstance(
                        err.exc_info[1],
                        (TransportError, UnavailableVideoError),
                    ) or (
                    ...
                    print(
                        f"Retrying: {try_num} failed tries\n\n##########\n\n"
                    )
            ...
            if (
                is_playlist
                and res_dict is not None
                and res_dict.get("entries")
            ):
