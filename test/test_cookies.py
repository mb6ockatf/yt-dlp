...
class TestCookies(unittest.TestCase):
    def test_get_desktop_environment(self):
        ...
        test_cases = [
            ...
            (
                ...
                _LinuxDesktopEnvironment.KDE4,
            ),
            (
                {"XDG_CURRENT_DESKTOP": "X-Cinnamon"},
                _LinuxDesktopEnvironment.CINNAMON,
            ),
            (
                {"XDG_CURRENT_DESKTOP": "Deepin"},
                _LinuxDesktopEnvironment.DEEPIN,
            ),
            ...
            (
                ...
                _LinuxDesktopEnvironment.UNITY,
            ),
            (
                {"XDG_CURRENT_DESKTOP": "Unity:Unity8"},
                _LinuxDesktopEnvironment.UNITY,
            ),
        ]
    ...
    def test_chrome_cookie_decryptor_linux_derive_key(self):
        ...
        self.assertEqual(
            key, b"7\xa1\xec\xd4m\xfcA\xc7\xb19Z\xd0\x19\xdcM\x17"
        )

    def test_chrome_cookie_decryptor_mac_derive_key(self):
        key = MacChromeCookieDecryptor.derive_key(b"abc")
        self.assertEqual(
            key, b"Y\xe2\xc0\xd0P\xf6\xf4\xe1l\xc1\x8cQ\xcb|\xcdY"
        )
    ...
    def test_chrome_cookie_decryptor_linux_v10(self):
        with MonkeyPatch(
            ...
            encrypted_value = (
                b'v10\xccW%\xcd\xe6\xe6\x9fM" \xa7\xb0\xca\xe4\x07\xd6'
            )
            value = "USD"
    ...
    def test_chrome_cookie_decryptor_linux_v10_meta24(self):
        with MonkeyPatch(
            ...
            value = "DE"
            decryptor = LinuxChromeCookieDecryptor(
                "Chrome", Logger(), meta_version=24
            )
            self.assertEqual(decryptor.decrypt(encrypted_value), value)
    ...
    def test_safari_cookie_parsing(self):
        ...
        expected_expiration = dt.datetime(
            2021, 6, 18, 21, 39, 19, tzinfo=dt.timezone.utc
        )
        ...
        self._run_tests(
            ...
            (
                ...
                "eggs=scrambled; httponly=foo; secure=bar; Path=/bacon",
                {
                    "eggs": (
                        "scrambled",
                        {"httponly": "foo", "secure": "bar", "path": "/bacon"},
                    )
                },
            ),
            (
            ...
            (
                ...
                {
                    "eggs": ("scrambled", {"secure": True, "path": "bar"}),
                    "foo": "foo",
                },
            ),
            (
        ...
        self._run_tests(
            ...
            (
                ...
                'Customer="WILE_E_COYOTE"; $Version=1; $Secure; $Path=/acme',
                {
                    "Customer": (
                        "WILE_E_COYOTE",
                        {"version": "1", "secure": True, "path": "/acme"},
                    )
                },
            ),
            (
